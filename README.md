...
**💼 총무의 부담** <br />
한 사람이 모든 결제를 맡아 책임이 집중되는 경우, 큰 금액을 관리해야 한다는 부담으로 여행을 온전히 즐기기 어렵습니다. <br/><br/>

**🗃 복잡한 정산 과정** <br />
결제 내역 별로 사용한 인원이 다를 경우, 정리하고 정산하는 과정이 복잡하여 피로도가 증가합니다. <br/><br/>
