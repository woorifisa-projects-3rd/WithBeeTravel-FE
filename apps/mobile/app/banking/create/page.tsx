...
export default function CreateAccountPage() {
  ...
  const productOptions: ProductOption[] = [
    {
      ...
      detail: "WON통장은 자유롭게 입출금이 가능하며, 언제든지 필요한 금액을 찾을 수 있는 유용한 통장입니다. 예금 이율은 1.5%로, 일정 잔액을 유지하면 높은 이율을 제공합니다. 통장 관리가 간편하고, 모바일 뱅킹으로 언제든지 확인할 수 있습니다."
    },
    {
      label: '우리닷컴통장',
      value: '모바일 전용 통장',
      imageUrl: '/imgs/friends/friends1.png',
      detail: "우리닷컴통장은 모바일 전용 통장으로, 전통적인 은행 창구 없이 스마트폰으로만 계좌 관리가 가능합니다. 연 2.0%의 예금 이율을 제공하며, 온라인 전용 혜택과 빠른 송금 서비스를 지원합니다. 24시간 이용 가능한 모바일 뱅킹으로 언제든지 편리하게 사용 가능합니다."
    },
    {
      label: 'WON파킹통장',
      value: '돈을 모아봐요',
      imageUrl: '/imgs/friends/friends3.png',
      detail: "WON파킹통장은 저축의 목적을 가진 통장으로, 1년에 한 번씩 이자 지급을 받습니다. 이율은 2.5%로, 돈을 묶어놓고 장기적으로 관리하고 싶은 분들에게 적합합니다. 최소 잔액이 없고, 언제든지 자금을 이동할 수 있어 유연하게 사용할 수 있습니다."
    },
    {
      label: '으쓱통장',
      value: '어깨가 으쓱으쓱',
      imageUrl: '/imgs/friends/friends4.png',
      detail: "으쓱통장은 일정 금액 이상 예치하면 더 높은 이율을 제공하는 우대 통장입니다. 기본 이율은 1.8%이며, 우대 조건을 충족하면 최대 3.0%까지 이자를 받을 수 있습니다. 월 1회 자유로운 출금이 가능하며, 우대 혜택을 받으려면 최소 예치 금액이 필요합니다."
    },
    {
      label: '보통예금',
      value: 'SIMPLE IS BEST',
      imageUrl: '/imgs/friends/friends5.png',
      detail: "보통예금은 간편한 예금 통장으로, 예치된 금액에 대해 연 1.2%의 기본 이율을 제공합니다. 예치 기간에 제한 없이 자유롭게 입출금이 가능하며, 예금액에 대한 이자는 매달 계산되어 지급됩니다. 간편하고 실용적인 통장으로, 적은 금액으로도 예금을 시작할 수 있습니다."
    }
  ];
  ...
  // 선택된 계좌의 상세 정보
  const selectedProductDetails = productOptions.find(option => option.label === selectedProduct);
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.accountContainer} >
        ...
        <AccountSelection productOptions={productOptions} onSelect={handleAccountSelect} />
      </div>
